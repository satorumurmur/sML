 ...
 *
 * - Thu October 14 23:44:00 2014 +0900
 */ sML = { Version: "0.999.8", Build: 20141014.0 };
...
if(sML.UA.InternetExplorer < 9) {
	...
	//
	Array.prototype.forEach = function(F, This) { for(var L = this.length, i = 0; i < L; i++) F.call(This, this[i], i, this); };
	//
